...
const courseSeed = [
  {
    ...
    subtitle: 'Build the support engine behind a dependable learning business.',
    summary:
    ...
    featured: true,
    prerequisites:
      'Best for new support managers, operations coordinators, and team leads with basic help desk experience.',
    learningOutcomes:
      'Learners will design escalation paths, document repeatable SOPs, track queue health, and run cleaner incident responses.',
    targetAudience:
      'Support leads and training operators building the first version of a learner support system.',
    materialsIncluded:
      'SOP templates, escalation matrix worksheets, weekly queue review scorecards, and sample comms.',
    supportDetails:
      'Includes weekly office hours, facilitator feedback on workflows, and private Slack support during the cohort.',
    enrollmentStartDate: '2026-02-15',
    enrollmentEndDate: '2026-03-10',
    courseStartDate: '2026-03-17',
  ...
  },
  {
    ...
    subtitle: 'Operational systems for repeatable, high-touch cohort launches.',
    summary:
    ...
    location: 'Kuala Lumpur Studio + Zoom',
    timezone: 'Asia/Kuala_Lumpur',
    durationHours: 24,
    ...
    featured: false,
    prerequisites:
      'Recommended for operators who have already supported at least one live cohort or workshop-based program.',
    learningOutcomes:
      'Participants will create launch checklists, facilitation cadences, office hour systems, and retention rituals.',
    targetAudience:
      'Program managers, academy operators, and CX leads responsible for running live learning experiences.',
    materialsIncluded:
      'Launch calendars, facilitator brief templates, office hour agendas, and retention reporting sheets.',
    supportDetails:
      'Two live labs each week, async review on delivery plans, and cohort peer feedback circles.',
    enrollmentStartDate: '2026-02-20',
    enrollmentEndDate: '2026-03-05',
  ...
  },
  {
    ...
    subtitle: 'Turn learner activity into dashboards leaders can act on.',
    summary:
    ...
    featured: true,
    prerequisites:
      'Learners should already understand spreadsheet basics and have access to their program data sources.',
    learningOutcomes:
      'Learners will define success metrics, model learner health, build executive dashboards, and communicate trends clearly.',
    targetAudience:
      'Training analysts, program ops teams, and enablement leaders who own reporting or executive updates.',
    materialsIncluded:
      'Dashboard wireframes, metric dictionaries, SQL starter prompts, and board-ready reporting examples.',
    supportDetails:
      'Monthly data clinics, review notes on dashboard architecture, and office-hour access for implementation questions.',
    enrollmentStartDate: '2026-02-01',
    enrollmentEndDate: '2026-04-01',
    courseStartDate: '2026-04-05',
    courseEndDate: '2026-06-05',
    accent: '#1a4f8c',
