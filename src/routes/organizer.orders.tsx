  ...
  return (
    <div className="page-stack">
      <section className="panel organizer-banner">
        <div>
          ...
          <p className="muted-copy">
            All purchase records for your events. Each confirmed order maps to
            an attendee enrollment.
          </p>
        </div>
      ...
      <section className="panel">
        ...
        {orders.length === 0 ? (
          <p className="muted-copy">No orders yet. Orders appear here once a purchase is completed.</p>
        ) : (
